...
class WsacarouselHelper
{
	...
	static function getNavigation(&$params, $mid) {
		...
		if(empty($pause) || !file_exists(JPATH_ROOT.DS.$pause)) $pause = urlencode('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pause" viewBox="0 0 16 16">
