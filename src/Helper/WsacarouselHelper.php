...
class WsacarouselHelper
{
	...
	static function getNavigation(&$params, $mid) {
	    ...
	    if(empty($play) ) $play = 'data:image/svg+xml;charset=UTF-8,' . rawurlencode('<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="white" stroke="#010101" stroke-width="2" stroke-opacity="0.5"  class="bi bi-play-fill" viewBox="0 0 384 512">
